...
export (int) var max_hitpoints : int = 200
...
const default_fps : float = 60.0

# The multiplier for adjusting the speed of the animation by BPM.
# See the function "set_speed_of_animation_by_BPM".
const default_animation_factor : float = default_fps / default_bpm

# Used for movement on the one-dimensional grid in a stage.
export (int) var grid_number : int = 0

# Round wins.
onready var wins : int = 0

# Round losses.
onready var losses : int = 0
...
onready var is_allowed_input : bool = true

func _ready():
	reset_hp()

# Sets the speed of the animations by bpm.
func set_speed_of_animation_by_BPM(bpm : float) -> void:
...
func _on_Character_win_round() -> void:
	# Play a win round animation.
	pass

# Not implemented in this scene.
func _on_Character_lose_round() -> void:
	# Play a lose round animation.
	pass

# Not implemented in this scene.
func _on_Character_lose_game() -> void:
	# Play a lose game animation
	pass

# Not implemented in this scene.
func _on_Character_win_game() -> void:
